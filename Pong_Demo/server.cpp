...
/*
    ...
    socket->connectToService(QBluetoothAddress("98:D3:32:10:7D:B0"), QBluetoothUuid(serviceUuid), QIODevice::ReadWrite);

    MyThread *thread = new MyThread(socket,++thread_id);
...
*/
    ...
    socket2->connectToService(QBluetoothAddress("00:15:83:35:94:CA"), QBluetoothUuid(serviceUuid2), QIODevice::ReadWrite);
