...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        ballPosition = new QLabel(centralWidget);
        ballPosition->setObjectName(QStringLiteral("ballPosition"));

        gridLayout->addWidget(ballPosition, 6, 0, 1, 2);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        ballPosition->setText(QApplication::translate("MainWindow", "TextLabel", nullptr));
    } // retranslateUi
