    ...
    P2iScore ( 0 )
{
    ...
    iLoop = new Gameplay(*scene, p1, p2, ball, this,this); // GamePlay objesi oluşturuldu. Oyunu bu yönetir.
...
void MainWindow::updatePos(QPointF pos){
    ui->ballPosition->setText("("+QString::number(pos.x()) +","+ QString::number(pos.y()) +")" );
}
